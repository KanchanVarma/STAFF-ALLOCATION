...
//Models
const EmployeeDomainMap = sequelize.define('employee_domain_map', {
    id: {
    type: Sequelize.INTEGER,
    primaryKey: true,
  },

  employee_id: {               //foreign key error
    type: Sequelize.INTEGER, 
     allowNull: false,
  },
...
EmployeeDomainMap.create({ id: 1 , employee_id: 101 , domain_id: 11,  status : "n", 
